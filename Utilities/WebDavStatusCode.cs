namespace WebDAVSharp.Server.Utilities
{
    ...
    internal enum WebDavStatusCode
    {
        ...
        ///     WebDAVSharp.Server.Utilities.WebDavStatusCode.UnprocessableEntity means the server understands the content type of
        ///     the request entity (hence a 415 (<see cref="System.Net.HttpStatusCode.UnsupportedMediaType" />) status code is
        ///     inappropriate), and the syntax of the request entity is correct (thus a 400 (
        ///     <see cref="System.Net.HttpStatusCode.BadRequest" />) status code is inappropriate) but was unable to process the
        ...
        ///     WebDAVSharp.Server.Utilities.WebDavStatusCode.Locked means the source or destination resource of a method is
        ///     locked.
        /// </summary>
        /// <remarks>
        ...
        ///     WebDAVSharp.Server.Utilities.WebDavStatusCode.FailedDependency means that the method could not be performed on the
        ...
        ///     WebDAVSharp.Server.Utilities.WebDavStatusCode.InsufficientStorage means the method could not be performed on the
        ///     resource because the server is unable to store the representation needed to successfully complete the request.
        /// </summary>
        /// <remarks>
